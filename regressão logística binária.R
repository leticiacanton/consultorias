...
dados <- read.table('dados_cccp.txt', header=TRUE)
...
boxplot.stats(dados$PAS)$out
boxplot.stats(dados$PAD)$out
boxplot.stats(dados$GLICEMIA)$out
boxplot.stats(dados$TGL)$out
boxplot.stats(dados$HDL)$out
boxplot.stats(dados$CC)$out
boxplot.stats(dados$CP)$out
boxplot.stats(dados$SM)$out
...
mod <- glm(SM ~ PAS+PAD+GLICEMIA+TGL+HDL+CC+CP,
